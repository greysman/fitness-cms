...
use App\Filament\Resources\Crm\EventResource\Pages;
...
class EventResource extends Resource
{
        ...
        return $form
            ->schema([
                ...
                UserSelect::make('contact_id')
                    ->label(trans('requests.form.contact.label'))
    ...
    public static function getCreateEditForm($request = null): array
    {
        return [
            Grid::make(5)->schema([
                Card::make([
                    ...
                    Grid::make(3)->schema([
                        ...
                        UserSelect::make('contact_id')
                            ...
                            ->default(function ($livewire) {
                                if ($livewire && isset($livewire->ownerRecord)) {
                                    return $livewire->ownerRecord->contact_id;
                                }
                            })
                            ->hidden(function ($livewire) {
                                if ($livewire && isset($livewire->ownerRecord)) {
                                    return $livewire->ownerRecord->contact_id != null;
                                }
                            })
                            ->required(),
